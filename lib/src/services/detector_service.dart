...
class Detector {
  static const String _packageName = 'realtime_image_labeler';
  static const String _modelPath = 'packages/$_packageName/assets/model.tflite';
  static const String _labelPath = 'packages/$_packageName/assets/labelmap.txt';
